define(["parse-js/parse-js"], function(mParseJs) {
var exports = {};
...
exports.transform = function(source, filters) {
    ...
    var ast = typeof(source) == 'string' ? mParseJs.parse(source) : source;
    // logDeep(ast[1]);
...
exports.PAIRS = PAIRS;
exports.NODE = NODE;
//exports.toAst = function(source) {
//    var ast = typeof(source) == 'string' ? mParseJs.parse(source, false, true /*want tokens*/) : source;
//    // logDeep(ast[1]);
//
//    // Convert Uglify's AST into a nicer object hierarchy
//    return arraysToNodes(ast[1]);
//};
